...
'''def demo(im_path):
    ...
    imageA = cv2.imread("im_path")
   # imageB = cv2.imread(result)
    ...
    (result, vis) = stitcher.stitch([imageA, result], showMatches=True)
    return result
'''
if __name__ == '__main__':
    ...
    imageA = cv2.imread("/home/ps/DiskA/project/dxf-pdf/pictures/pictures/test_280x160_000000_S007.png")
    imageB = cv2.imread("/home/ps/DiskA/project/dxf-pdf/pictures/pictures/test_280x160_000001_S008.png")
    imageA = cv2.resize(imageA, None, fx=0.5, fy=0.5, interpolation=cv2.INTER_CUBIC)  # 缩放
    imageB = cv2.resize(imageB, None, fx=0.5, fy=0.5, interpolation=cv2.INTER_CUBIC)
